...
| shrewd (builds positions, buys odds, stewards a lean base) | **~50%** | see `node tools/simulate.js` for the per-tank ladder (47% at the last run, with rivals now poaching donors and whispering) |
