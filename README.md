...
- **Rivals with brains.** Every rival has a style — the Establishment funds broadly and defends its leads, the Battleship picks two fights and closes hard, the Dealmaker rides favorites for cheap credit, the Insurgent hunts upsets, the Sniper hoards then dumps, the Purist never crosses its lean, BLAND mirrors the leader — with four knobs each (`ai:` on the tank: focus, patience, aggression, grudge). Your institution's difficulty sets how much of it they use: **Easy** rivals roll dice (fixed weights, no memory); **Medium** rivals price every fight (the influence needed to reach ~80% odds *and* top credit), fund the cheapest victories, and bank the rest in a war chest whose patience is a matter of style; **Hard** rivals also poach with aim (your best scholar in the field they keep losing) and add issues they lose twice to their portfolio; **Expert** sharpens their targets. It's legible: hover a rival on the leaderboard for their chest, this month's spending and what they're eyeing, the Bugle reports hoarding and all-in months, and a Gov Relations Lead reads their intentions onto the fight cards. The optimizer replaced most of the old handicaps (drift, frontrunner heat and closing multipliers were all dialed down).
...
| shrewd (builds positions, buys odds, stewards a lean base) | **~40%** | the per-tank ladder is the point now: Easy tanks (dice rivals) 72–77%, Medium (thinking rivals) 36–48%, Hard/Expert (pooled credit, leader denial) ~0% for the bot |
