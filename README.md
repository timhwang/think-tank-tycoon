...
| shrewd (builds positions, buys odds, stewards a lean base) | **~50%** | see `node tools/simulate.js` for the per-tank ladder (51% at the last run, whales half-weighted by the bot) |
