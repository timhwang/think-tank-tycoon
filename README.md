...
- **Influence.** Spend it on **policy fights** (bills, executive orders, nominations — a rotating board of 4). Each fight is a tug-of-war between two sides; rival think tanks pile on every month, and the ⚑ attribution line under each side shows exactly who's backing it and with how much. When the clock hits zero the bigger pile wins, and winners are paid the reward scaled by their share of the winning side.
...
| `icons/` | 67 pixel-art icons (every fight, donor, program, and tank, plus 12 scholar portraits and 8 ops roles) |
