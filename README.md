...
- **Cuts have consequences.** Ops are expendable, but firing a scholar unsettles donors (worse if it strands a donor's demand), and parting with a donor demoralizes the scholars whose issue they funded.
