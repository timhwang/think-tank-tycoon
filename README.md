...
| shrewd (builds positions, buys odds, stewards a lean base) | **~40%** | the per-tank ladder is the point now: Easy tanks (dice rivals) 68–81%, Medium (thinking rivals) 41–45%, Hard/Expert (pooled credit, leader denial) ~0% for the bot |
